"""Alias shim: this in-tree module IS ba2_experts.FMPEarningsEvent (Phase 6 migration).
...
operate on the real package module. Single source of truth: ba2_experts.FMPEarningsEvent."""
import importlib as _importlib
import sys as _sys

_pkg = _importlib.import_module("ba2_experts.FMPEarningsEvent")
