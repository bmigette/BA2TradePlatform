...
ALLOWLIST: dict = {
    ...
    "packages/common/ba2_common/core/TradeActions.py:2032":
        ...
        "(side classification, filled-quantity guard, shared expert id)",
