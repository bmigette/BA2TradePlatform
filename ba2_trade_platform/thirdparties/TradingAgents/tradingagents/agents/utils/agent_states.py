...
class AgentState(MessagesState):
    ...
    market_analysis_id: Annotated[Optional[int], "MarketAnalysis database ID for this analysis run"]
    ...
    investment_judge_verdict: Annotated[dict, "Structured InvestmentJudgeVerdict from the research manager"]

    trader_investment_plan: Annotated[str, "Plan generated by the Trader"]
    trader_decision: Annotated[dict, "Structured TraderDecision (action/confidence/etc.) when the Trader returns pydantic output"]
    risk_judge_verdict: Annotated[dict, "Structured RiskJudgeVerdict from the risk manager"]
