...
# --------------------------------------------------------------------------- #
ALLOWLIST: dict = {
    "ba2_trade_platform/ui/pages/settings.py:4389":
