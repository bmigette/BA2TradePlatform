"""Alias shim: this in-tree module IS ba2_providers.StockScreener (Phase 6 migration).
...
operate on the real package module. Single source of truth: ba2_providers.StockScreener."""
