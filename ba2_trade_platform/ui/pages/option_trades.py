...
from ...core.option_pnl_display import (
    UNAVAILABLE_INCOMPLETE, open_option_transaction_pnl, option_closed_pnl, quote_caching_account,
    unavailable_pnl,
)
            ...
            if is_open and leg_set.incomplete:
                ...
                if account_id:
                    ...
                    if account_inst is not None:
                        ...
                        # The shared helper picks the representative + dispatches by the
                        # structure (review R1) -- the floating P/L cards call the same one.
                        current_pnl, _ = open_option_transaction_pnl(account_inst, txn, orders)
                        if leg_set.count == 1:
