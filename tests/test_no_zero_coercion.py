...
# --------------------------------------------------------------------------- #
ALLOWLIST: dict = {
    "ba2_trade_platform/ui/pages/settings.py:3850":
        ...
        "market-condition profile widget + guard of plan Task 12 moved it to :3850)",
    "ba2_trade_platform/ui/pages/settings.py:3898":
        ...
        "Task 12's widget + guard then moved the pair to :3850/:3898)",
